...
System Specs (Kernel, Memory, Disk): Evidence of uname -a, free -h, and df -h commands running on ARM64 architecture.

IP Address Configuration: Evidence of ip addr showing valid IP assignment.

Successful Remote SSH Connection: Demonstration of successful remote login from macOS terminal to Ubuntu Server.
